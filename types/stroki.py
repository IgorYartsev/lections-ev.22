...
# Строки - это набор последовательных символов которые мы используем для хранаения и представления тексовой ифонрмации
...
# """
# name3 =str("John Snow")
# """Сейчас мы все это выведем на экран"""
...
# print ('Hello,mr/mrs' ,name ,last_name)  #не рекомндуется
...
# name = 'Hello' 
# print(name[-1:]+ name[1:-1]+ name[0:1])
